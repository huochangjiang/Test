...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	pulltoRefreshLiserener pulltorefreshLisener;
	public void setMovieLisener(pulltoRefreshLiserener pull){
		this.pulltorefreshLisener=pull;
	}
	@Override
	public  boolean onTouchEvent(MotionEvent event) {
		Log.e("info", "1111111");
		if(pulltorefreshLisener!=null){
			pulltorefreshLisener.ontouMovevent(event);
			Log.e("info", "222222");
		}
		Log.e("info", "3333333");
		if (!isPullToRefreshEnabled()) {
	...
	static interface OnSmoothScrollFinishedListener {
	  ...
	  public interface pulltoRefreshLiserener{
		  void ontouMovevent(MotionEvent event);
