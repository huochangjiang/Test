 ...
 */
public class XianStatusListAdapter extends RecyclerView.Adapter{
    private Context mContext;
    private LayoutInflater mLayoutInflater;
    private List<XianStatusList.DataBean> mDatas;
    ...
    public XianStatusListAdapter(Context context,List<XianStatusList.DataBean> data){
        this.mContext=context;
        this.mDatas=data;
        mLayoutInflater=LayoutInflater.from(context);
    }
    public void dataChange(List<XianStatusList.DataBean> data,boolean isHave){
        this.isHave=isHave;
        this.mDatas=data;
    ...
    public interface OnitemClick{
        void onitemClice(XianStatusList.DataBean data);
    }
    @Override
