 ...
 */
public class SearchProjectMangerActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    private MyEditText search;
    private String fenlei;
    private RecyclerView recyclerView;
    private SwipeRefreshLayout pullToRefresh;
    private ProjectMangerAdpater mAdapter;
    private List<ProjectManger.DataBean> leaderActivitys=new ArrayList<>();
    private int mPage=0;
    ...
    protected int getLayoutId() {
        return R.layout.activity_search_project_manger;
    }
