 ...
 */
public class SearchTaskNotifiListActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected int getLayoutId() {
        return R.layout.activity_search_task_notifi_list;
    }
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        mAdapter = new TaskNotifiListAdapter(this,leaderActivitys);
    ...
    private void initSearch(String key) {
        if(App.getContext().getLogo("logo")!=null) {
            TaskNotifiListBeen canshus = new TaskNotifiListBeen(new TaskNotifiListBeen.UserBean(App.getContext().getLogo("logo").data.id, "1234567890"),
                    new TaskNotifiListBeen.DataBean(fenlei,key,mPageSearch+"",mPageSize+""));
