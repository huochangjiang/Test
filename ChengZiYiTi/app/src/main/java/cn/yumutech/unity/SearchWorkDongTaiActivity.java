 ...
 */
public class SearchWorkDongTaiActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    private MyEditText search;
    private String fenlei;
    private RecyclerView recyclerView;
    private SwipeRefreshLayout pullToRefresh;
    private WorkDongTaiAdapter mAdapter;
    private List<WorkListManger.DataBean> leaderActivitys=new ArrayList<>();
    private int mPage=0;
    ...
    protected int getLayoutId() {
        return R.layout.activity_search_work_dong_tai;
    }
